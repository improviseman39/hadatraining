  ...
  return (
    <>
      <button
        ...
        aria-label="Search"
        className="flex h-9 items-center gap-1.5 rounded-full px-2.5 text-ink/80 transition-colors hover:bg-ink/5 hover:text-teal sm:border sm:border-ink/15 sm:px-3"
      >
